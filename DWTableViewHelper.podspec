Pod::Spec.new do |s|
  ...
  s.description  = "DWTableViewHelper is a tool object to slim your ViewController and let you build a tableView easily.DWTableViewHelper能够瘦身你的控制器，达到解耦效果，并且提供一些便捷的TableView开发接口。"
